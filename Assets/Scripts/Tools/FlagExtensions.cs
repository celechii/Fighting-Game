...
public static class FlagExtensions {
	...
	/// </summary>
	public static bool HasEach<TEnum>(this TEnum multiEnum, params TEnum[] flags)where TEnum : struct, IConvertible {
	...
	public static void Set<TEnum>(ref this TEnum multiEnum, TEnum flag, bool on)where TEnum : struct, IConvertible {
		if (on)
			multiEnum.Add(flag);
		else
			multiEnum.Remove(flag);
	}
